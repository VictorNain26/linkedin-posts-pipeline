        ...
        system=[
            {
                ...
                "text": (
                    ...
                    "</role>\n\n"
                    "<audience>\n"
                    "Fondateurs, CEOs et CTOs de startups et PME tech françaises qui envisagent "
                    "d'intégrer l'IA dans leur produit ou leurs process. À l'aise avec le vocabulaire "
                    "produit/tech de base, PAS experts IA/ML. Sensibles au passage à l'acte : "
                    "ROI, time-to-value, build vs buy, comment s'y prendre — et aussi aux risques "
                    "(coût récurrent, lock-in, fiabilité en prod, conformité).\n"
                    "</audience>\n\n"
                    "<task>\n"
